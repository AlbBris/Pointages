...
- Aucune dépendance serveur : la V1.14 reste entièrement utilisable en local.
...
## V1.14 — Prêt de Main d’œuvre & export iBAT S38
- Nouveau type de personnel « Prêt de Main d’œuvre » en plus de GCC et Intérim.
- Horaires par défaut dédiés au prêt de main d’œuvre.
- Le prêt de main d’œuvre n’est pas soumis au module de contrats intérimaires.
- Filtre et badge dédiés dans le pointage.
- Export iBAT aligné sur le tableau S38 fourni : titre, métadonnées, colonnes et couleurs.
- Une ligne blanche est insérée entre chaque personne pour faciliter la ressaisie dans iBAT Temps.
- Les personnes en prêt de main d’œuvre apparaissent comme « Prêt de MO » avec leur entreprise d’origine.
- La ventilation complète distingue désormais S (GCC), I (Intérim) et P (Prêt de MO).



## V1.14.3 — Zone de déplacement uniquement

- Suppression complète de la notion de zone chantier dans l’interface.
- Suppression de la zone par défaut du chantier.
- Conservation uniquement de la **zone de déplacement** (`Z1`, `Z2`, `Z5`…) pour les personnels externes.
- Les exports CSV, Ventilation, Saisie iBAT, Détail iBAT et fiches individuelles utilisent uniquement la zone de déplacement.
- Les anciennes valeurs de zone chantier sont ignorées automatiquement à l’ouverture.
